...
const FilterModal = ({ isOpen, onClose, onApplyFilters, filters }: FilterModalProps) => {
      ...
      <Card className="w-full max-w-md bg-[#062B4B] border-white/20">
        ...
        <CardContent className="space-y-4">
          <div className="space-y-2">
            ...
            <Select value={localFilters.city} onValueChange={(value) => setLocalFilters({...localFilters, city: value})}>
          ...
          <div className="space-y-2">
            ...
            <Select value={localFilters.neighborhood} onValueChange={(value) => setLocalFilters({...localFilters, neighborhood: value})}>
              <SelectTrigger className="bg-white/10 border-white/20 text-white">
          ...
          <div className="space-y-2">
            ...
            <Select value={localFilters.modality} onValueChange={(value) => setLocalFilters({...localFilters, modality: value})}>
              <SelectTrigger className="bg-white/10 border-white/20 text-white">
          ...
          <div className="space-y-2">
            ...
            <Select value={localFilters.operatingHours} onValueChange={(value) => setLocalFilters({...localFilters, operatingHours: value})}>
              <SelectTrigger className="bg-white/10 border-white/20 text-white">
