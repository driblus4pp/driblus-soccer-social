...
const FilterModal = ({
  ...
  return (
    <div className="fixed inset-0 z-50 bg-black/50 flex items-start justify-center p-4 pt-20">
      <div className="filter-modal-drop">
          ...
          <CardContent className="space-y-4">
            ...
            <div className="space-y-2">
              ...
              >
                ...
                <SelectContent className="bg-[#062B4B] border-white/20">
                  <SelectItem value="aldeota" className="text-white focus:bg-white/20">Aldeota</SelectItem>
                  <SelectItem value="meireles" className="text-white focus:bg-white/20">Meireles</SelectItem>
                  <SelectItem value="coco" className="text-white focus:bg-white/20">Cocó</SelectItem>
                </SelectContent>
              </Select>
            </div>
            ...
            <div className="flex gap-3 pt-4">
              <Button 
                ...
                className="flex-1 border-white/20 bg-gray-500 hover:bg-gray-400 text-zinc-950"
              >
                Cancelar
              </Button>
              <Button 
