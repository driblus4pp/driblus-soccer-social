...
const navigationConfig = {
  client: [
    { id: 'home', label: 'Início', icon: Home, route: '/cliente/dashboard' },
  ...
  manager: [
    ...
    { id: 'bookings', label: 'Agendamentos', icon: Calendar, route: '/gestor/agendamentos' },
    { id: 'court', label: 'Quadra', icon: Building2, route: '/gestor/quadra/configurar' },
    { id: 'reports', label: 'Relatórios', icon: BarChart3, route: '/gestor/relatorios' },
    { id: 'profile', label: 'Perfil', icon: User, route: '/gestor/perfil' },
  ],
  admin: [
    { id: 'dashboard', label: 'Dashboard', icon: Home, route: '/admin/dashboard' },
    { id: 'courts', label: 'Quadras', icon: Building2, route: '/admin/quadras' },
    { id: 'managers', label: 'Gestores', icon: Users, route: '/admin/gestores' },
    { id: 'bookings', label: 'Agendamentos', icon: Calendar, route: '/admin/agendamentos' },
    { id: 'settings', label: 'Config', icon: Settings, route: '/admin/configuracoes' },
  ],
};
