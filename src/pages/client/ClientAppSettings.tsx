  ...
  return <div className="min-h-screen bg-[#093758] pb-20">
      ...
      <div className="px-4 py-6 bg-[#093758]">
        <div className="flex items-center gap-4 mb-6">
          <Button variant="ghost" size="icon" onClick={() => navigate('/cliente/perfil')} className="text-white hover:bg-white/10">
        ...
        <Card className="bg-white/10 border-white/20">
          ...
          <CardContent className="space-y-4">
            ...
            <div className="flex items-center justify-between">
              ...
              <Switch checked={settings.smsNotifications} onCheckedChange={value => updateSetting('smsNotifications', value)} />
            </div>
          </CardContent>
        </Card>
        ...
        <Card className="bg-white/10 border-white/20">
          ...
          <CardContent className="space-y-4">
            <div className="flex items-center justify-between">
              ...
              <Switch checked={settings.locationServices} onCheckedChange={value => updateSetting('locationServices', value)} />
            </div>
          </CardContent>
        </Card>
        ...
        <Card className="bg-white/10 border-white/20">
          ...
          <CardContent className="space-y-4">
            <div className="flex items-center justify-between">
              ...
              <Switch checked={settings.showProfile} onCheckedChange={value => updateSetting('showProfile', value)} />
            </div>
            <div className="flex items-center justify-between">
              <div>
              ...
              <Switch checked={settings.allowReviews} onCheckedChange={value => updateSetting('allowReviews', value)} />
            </div>
          </CardContent>
        </Card>
