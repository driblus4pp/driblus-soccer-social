  ...
  return <div className="min-h-screen bg-gradient-to-br from-[#062B4B] via-[#0A3B5C] to-[#062B4B] flex items-center justify-center p-4">
      <div className="w-full max-w-md">
        <div className="flex items-center gap-4 mb-6">
          <Button variant="ghost" size="icon" onClick={() => navigate('/cliente/login')} className="text-white hover:bg-white/20">
          ...
          <CardContent>
            <form onSubmit={handleRegister} className="space-y-4">
              <div className="relative">
                ...
                <Input placeholder="Nome completo" value={formData.name} onChange={e => setFormData(prev => ({
                ...prev,
                name: e.target.value
              ...
              <div className="relative">
                ...
                <Input placeholder="Email" type="email" value={formData.email} onChange={e => setFormData(prev => ({
                ...prev,
              ...
              <div className="relative">
                ...
                <Input placeholder="Telefone (com DDD)" type="tel" value={formData.phone} onChange={e => setFormData(prev => ({
                ...prev,
